---
name: sora-lattice-ui
description: Guidelines for building consistent UI in the Sora Lattice web app. Covers typography, color, spacing, motion, accessibility, performance, and component patterns. Use when adding new pages, sections, components, or interactive features to the Astro/React frontend.
---

# Sora Lattice UI Guidelines
