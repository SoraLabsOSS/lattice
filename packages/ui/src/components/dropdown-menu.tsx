...
import { usePortalContainer } from "@sora-lattice/ui/lib/portal-container";
...
function DropdownMenuPortal({
  ...
  const resolved = usePortalContainer(container ?? undefined);
  return (
...
function DropdownMenuContent({
  ...
  return (
    <MenuPrimitive.Portal container={resolved}>
